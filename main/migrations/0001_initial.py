# Generated by Django 4.2 on 2025-04-10 06:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField()),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_reply', to='main.comment')),
                ('ques', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ques_reply', to='main.question')),
        ...
        migrations.AddField(
            model_name='comment',
            name='ques',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ques_comment', to='main.question'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
